...
module audio_nios_mm_interconnect_1 (
	...
	wire  [83:0] seg7_avalon_slave_agent_rf_source_data;                                      // seg7_avalon_slave_agent:rf_source_data -> seg7_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [83:0] seg7_avalon_slave_agent_rsp_fifo_out_data;                                   // seg7_avalon_slave_agent_rsp_fifo:out_data -> seg7_avalon_slave_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> seg7_avalon_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // seg7_avalon_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> seg7_avalon_slave_agent:cp_channel
	...
	wire  [83:0] key_s1_agent_rf_source_data;                                                 // key_s1_agent:rf_source_data -> key_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] key_s1_agent_rsp_fifo_out_data;                                              // key_s1_agent_rsp_fifo:out_data -> key_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> key_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // key_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> key_s1_agent:cp_channel
	...
	wire  [83:0] pio_led_s1_agent_rf_source_data;                                             // pio_led_s1_agent:rf_source_data -> pio_led_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] pio_led_s1_agent_rsp_fifo_out_data;                                          // pio_led_s1_agent_rsp_fifo:out_data -> pio_led_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> pio_led_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // pio_led_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> pio_led_s1_agent:cp_channel
	...
	wire  [83:0] sw_s1_agent_rf_source_data;                                                  // sw_s1_agent:rf_source_data -> sw_s1_agent_rsp_fifo:in_data
	...
	wire  [83:0] sw_s1_agent_rsp_fifo_out_data;                                               // sw_s1_agent_rsp_fifo:out_data -> sw_s1_agent:rf_sink_data
	...
	wire  [82:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> sw_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // sw_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> sw_s1_agent:cp_channel
	...
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> i2c_scl_s1_agent:cp_valid
	wire  [82:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> i2c_scl_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // i2c_scl_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> i2c_scl_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> i2c_scl_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> i2c_scl_s1_agent:cp_endofpacket
	...
	wire  [82:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> i2c_sda_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // i2c_sda_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> i2c_sda_s1_agent:cp_channel
	...
	wire  [82:0] seg7_avalon_slave_agent_rp_data;                                             // seg7_avalon_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [82:0] key_s1_agent_rp_data;                                                        // key_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [82:0] pio_led_s1_agent_rp_data;                                                    // pio_led_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [82:0] sw_s1_agent_rp_data;                                                         // sw_s1_agent:rp_data -> router_004:sink_data
	...
	wire         i2c_scl_s1_agent_rp_valid;                                                   // i2c_scl_s1_agent:rp_valid -> router_005:sink_valid
	wire  [82:0] i2c_scl_s1_agent_rp_data;                                                    // i2c_scl_s1_agent:rp_data -> router_005:sink_data
	wire         i2c_scl_s1_agent_rp_ready;                                                   // router_005:sink_ready -> i2c_scl_s1_agent:rp_ready
	wire         i2c_scl_s1_agent_rp_startofpacket;                                           // i2c_scl_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         i2c_scl_s1_agent_rp_endofpacket;                                             // i2c_scl_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         i2c_sda_s1_agent_rp_valid;                                                   // i2c_sda_s1_agent:rp_valid -> router_006:sink_valid
	wire  [82:0] i2c_sda_s1_agent_rp_data;                                                    // i2c_sda_s1_agent:rp_data -> router_006:sink_data
	wire         i2c_sda_s1_agent_rp_ready;                                                   // router_006:sink_ready -> i2c_sda_s1_agent:rp_ready
	wire         i2c_sda_s1_agent_rp_startofpacket;                                           // i2c_sda_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         i2c_sda_s1_agent_rp_endofpacket;                                             // i2c_sda_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire   [5:0] router_src_channel;                                                          // router:src_channel -> cpu_peripheral_bridge_m0_limiter:cmd_sink_channel
	...
	wire   [5:0] cpu_peripheral_bridge_m0_limiter_cmd_src_channel;                            // cpu_peripheral_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [5:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> cpu_peripheral_bridge_m0_limiter:rsp_sink_channel
	...
	wire   [5:0] cpu_peripheral_bridge_m0_limiter_rsp_src_channel;                            // cpu_peripheral_bridge_m0_limiter:rsp_src_channel -> cpu_peripheral_bridge_m0_agent:rp_channel
	...
	wire   [5:0] cpu_peripheral_bridge_m0_limiter_cmd_valid_data;                             // cpu_peripheral_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         seg7_avalon_slave_agent_rdata_fifo_src_valid;                                // seg7_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] seg7_avalon_slave_agent_rdata_fifo_src_data;                                 // seg7_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         seg7_avalon_slave_agent_rdata_fifo_src_ready;                                // avalon_st_adapter:in_0_ready -> seg7_avalon_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                               // avalon_st_adapter:out_0_valid -> seg7_avalon_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                // avalon_st_adapter:out_0_data -> seg7_avalon_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                               // seg7_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                               // avalon_st_adapter:out_0_error -> seg7_avalon_slave_agent:rdata_fifo_sink_error
	wire         key_s1_agent_rdata_fifo_src_valid;                                           // key_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] key_s1_agent_rdata_fifo_src_data;                                            // key_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         key_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_001:in_0_ready -> key_s1_agent:rdata_fifo_src_ready
	...
	wire         i2c_scl_s1_agent_rdata_fifo_src_valid;                                       // i2c_scl_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] i2c_scl_s1_agent_rdata_fifo_src_data;                                        // i2c_scl_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         i2c_scl_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_004:in_0_ready -> i2c_scl_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> i2c_scl_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> i2c_scl_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // i2c_scl_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> i2c_scl_s1_agent:rdata_fifo_sink_error
	...
	audio_nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (seg7_avalon_slave_agent_rdata_fifo_src_data),                //     in_0.data
		.in_0_valid     (seg7_avalon_slave_agent_rdata_fifo_src_valid),               //         .valid
		.in_0_ready     (seg7_avalon_slave_agent_rdata_fifo_src_ready),               //         .ready
