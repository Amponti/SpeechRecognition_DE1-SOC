...
`timescale 1 ps / 1 ps
module hps_fpga_mm_interconnect_1 (
		...
		output wire [1:0]  config_audio_s1_address,                                           //                                             config_audio_s1.address
		output wire        config_audio_s1_write,                                             //                                                            .write
		input  wire [31:0] config_audio_s1_readdata,                                          //                                                            .readdata
		output wire [31:0] config_audio_s1_writedata,                                         //                                                            .writedata
		output wire        config_audio_s1_chipselect,                                        //                                                            .chipselect
		...
		output wire [1:0]  play_d_s1_address,                                                 //                                                   play_d_s1.address
		output wire        play_d_s1_write,                                                   //                                                            .write
		input  wire [31:0] play_d_s1_readdata,                                                //                                                            .readdata
		output wire [31:0] play_d_s1_writedata,                                               //                                                            .writedata
		output wire        play_d_s1_chipselect,                                              //                                                            .chipselect
		output wire [1:0]  record_d_s1_address,                                               //                                                 record_d_s1.address
		output wire        record_d_s1_write,                                                 //                                                            .write
		input  wire [31:0] record_d_s1_readdata,                                              //                                                            .readdata
		output wire [31:0] record_d_s1_writedata,                                             //                                                            .writedata
		output wire        record_d_s1_chipselect,                                            //                                                            .chipselect
	...
	wire  [116:0] sw_s1_agent_rf_source_data;                             // sw_s1_agent:rf_source_data -> sw_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] sw_s1_agent_rsp_fifo_out_data;                          // sw_s1_agent_rsp_fifo:out_data -> sw_s1_agent:rf_sink_data
	...
	wire   [31:0] record_d_s1_agent_m0_readdata;                          // record_d_s1_translator:uav_readdata -> record_d_s1_agent:m0_readdata
	wire          record_d_s1_agent_m0_waitrequest;                       // record_d_s1_translator:uav_waitrequest -> record_d_s1_agent:m0_waitrequest
	wire          record_d_s1_agent_m0_debugaccess;                       // record_d_s1_agent:m0_debugaccess -> record_d_s1_translator:uav_debugaccess
	wire   [20:0] record_d_s1_agent_m0_address;                           // record_d_s1_agent:m0_address -> record_d_s1_translator:uav_address
	wire    [3:0] record_d_s1_agent_m0_byteenable;                        // record_d_s1_agent:m0_byteenable -> record_d_s1_translator:uav_byteenable
	wire          record_d_s1_agent_m0_read;                              // record_d_s1_agent:m0_read -> record_d_s1_translator:uav_read
	wire          record_d_s1_agent_m0_readdatavalid;                     // record_d_s1_translator:uav_readdatavalid -> record_d_s1_agent:m0_readdatavalid
	wire          record_d_s1_agent_m0_lock;                              // record_d_s1_agent:m0_lock -> record_d_s1_translator:uav_lock
	wire   [31:0] record_d_s1_agent_m0_writedata;                         // record_d_s1_agent:m0_writedata -> record_d_s1_translator:uav_writedata
	wire          record_d_s1_agent_m0_write;                             // record_d_s1_agent:m0_write -> record_d_s1_translator:uav_write
	wire    [2:0] record_d_s1_agent_m0_burstcount;                        // record_d_s1_agent:m0_burstcount -> record_d_s1_translator:uav_burstcount
	wire          record_d_s1_agent_rf_source_valid;                      // record_d_s1_agent:rf_source_valid -> record_d_s1_agent_rsp_fifo:in_valid
	wire  [116:0] record_d_s1_agent_rf_source_data;                       // record_d_s1_agent:rf_source_data -> record_d_s1_agent_rsp_fifo:in_data
	wire          record_d_s1_agent_rf_source_ready;                      // record_d_s1_agent_rsp_fifo:in_ready -> record_d_s1_agent:rf_source_ready
	wire          record_d_s1_agent_rf_source_startofpacket;              // record_d_s1_agent:rf_source_startofpacket -> record_d_s1_agent_rsp_fifo:in_startofpacket
	wire          record_d_s1_agent_rf_source_endofpacket;                // record_d_s1_agent:rf_source_endofpacket -> record_d_s1_agent_rsp_fifo:in_endofpacket
	wire          record_d_s1_agent_rsp_fifo_out_valid;                   // record_d_s1_agent_rsp_fifo:out_valid -> record_d_s1_agent:rf_sink_valid
	wire  [116:0] record_d_s1_agent_rsp_fifo_out_data;                    // record_d_s1_agent_rsp_fifo:out_data -> record_d_s1_agent:rf_sink_data
	wire          record_d_s1_agent_rsp_fifo_out_ready;                   // record_d_s1_agent:rf_sink_ready -> record_d_s1_agent_rsp_fifo:out_ready
	wire          record_d_s1_agent_rsp_fifo_out_startofpacket;           // record_d_s1_agent_rsp_fifo:out_startofpacket -> record_d_s1_agent:rf_sink_startofpacket
	wire          record_d_s1_agent_rsp_fifo_out_endofpacket;             // record_d_s1_agent_rsp_fifo:out_endofpacket -> record_d_s1_agent:rf_sink_endofpacket
	wire          record_d_s1_agent_rdata_fifo_src_valid;                 // record_d_s1_agent:rdata_fifo_src_valid -> record_d_s1_agent_rdata_fifo:in_valid
	wire   [33:0] record_d_s1_agent_rdata_fifo_src_data;                  // record_d_s1_agent:rdata_fifo_src_data -> record_d_s1_agent_rdata_fifo:in_data
	wire          record_d_s1_agent_rdata_fifo_src_ready;                 // record_d_s1_agent_rdata_fifo:in_ready -> record_d_s1_agent:rdata_fifo_src_ready
	wire   [31:0] play_d_s1_agent_m0_readdata;                            // play_d_s1_translator:uav_readdata -> play_d_s1_agent:m0_readdata
	wire          play_d_s1_agent_m0_waitrequest;                         // play_d_s1_translator:uav_waitrequest -> play_d_s1_agent:m0_waitrequest
	wire          play_d_s1_agent_m0_debugaccess;                         // play_d_s1_agent:m0_debugaccess -> play_d_s1_translator:uav_debugaccess
	wire   [20:0] play_d_s1_agent_m0_address;                             // play_d_s1_agent:m0_address -> play_d_s1_translator:uav_address
	wire    [3:0] play_d_s1_agent_m0_byteenable;                          // play_d_s1_agent:m0_byteenable -> play_d_s1_translator:uav_byteenable
	wire          play_d_s1_agent_m0_read;                                // play_d_s1_agent:m0_read -> play_d_s1_translator:uav_read
	wire          play_d_s1_agent_m0_readdatavalid;                       // play_d_s1_translator:uav_readdatavalid -> play_d_s1_agent:m0_readdatavalid
	wire          play_d_s1_agent_m0_lock;                                // play_d_s1_agent:m0_lock -> play_d_s1_translator:uav_lock
	wire   [31:0] play_d_s1_agent_m0_writedata;                           // play_d_s1_agent:m0_writedata -> play_d_s1_translator:uav_writedata
	wire          play_d_s1_agent_m0_write;                               // play_d_s1_agent:m0_write -> play_d_s1_translator:uav_write
	wire    [2:0] play_d_s1_agent_m0_burstcount;                          // play_d_s1_agent:m0_burstcount -> play_d_s1_translator:uav_burstcount
	wire          play_d_s1_agent_rf_source_valid;                        // play_d_s1_agent:rf_source_valid -> play_d_s1_agent_rsp_fifo:in_valid
	wire  [116:0] play_d_s1_agent_rf_source_data;                         // play_d_s1_agent:rf_source_data -> play_d_s1_agent_rsp_fifo:in_data
	wire          play_d_s1_agent_rf_source_ready;                        // play_d_s1_agent_rsp_fifo:in_ready -> play_d_s1_agent:rf_source_ready
	wire          play_d_s1_agent_rf_source_startofpacket;                // play_d_s1_agent:rf_source_startofpacket -> play_d_s1_agent_rsp_fifo:in_startofpacket
	wire          play_d_s1_agent_rf_source_endofpacket;                  // play_d_s1_agent:rf_source_endofpacket -> play_d_s1_agent_rsp_fifo:in_endofpacket
	wire          play_d_s1_agent_rsp_fifo_out_valid;                     // play_d_s1_agent_rsp_fifo:out_valid -> play_d_s1_agent:rf_sink_valid
	wire  [116:0] play_d_s1_agent_rsp_fifo_out_data;                      // play_d_s1_agent_rsp_fifo:out_data -> play_d_s1_agent:rf_sink_data
	wire          play_d_s1_agent_rsp_fifo_out_ready;                     // play_d_s1_agent:rf_sink_ready -> play_d_s1_agent_rsp_fifo:out_ready
	wire          play_d_s1_agent_rsp_fifo_out_startofpacket;             // play_d_s1_agent_rsp_fifo:out_startofpacket -> play_d_s1_agent:rf_sink_startofpacket
	wire          play_d_s1_agent_rsp_fifo_out_endofpacket;               // play_d_s1_agent_rsp_fifo:out_endofpacket -> play_d_s1_agent:rf_sink_endofpacket
	wire          play_d_s1_agent_rdata_fifo_src_valid;                   // play_d_s1_agent:rdata_fifo_src_valid -> play_d_s1_agent_rdata_fifo:in_valid
	wire   [33:0] play_d_s1_agent_rdata_fifo_src_data;                    // play_d_s1_agent:rdata_fifo_src_data -> play_d_s1_agent_rdata_fifo:in_data
	wire          play_d_s1_agent_rdata_fifo_src_ready;                   // play_d_s1_agent_rdata_fifo:in_ready -> play_d_s1_agent:rdata_fifo_src_ready
	wire   [31:0] config_audio_s1_agent_m0_readdata;                      // config_audio_s1_translator:uav_readdata -> config_audio_s1_agent:m0_readdata
	wire          config_audio_s1_agent_m0_waitrequest;                   // config_audio_s1_translator:uav_waitrequest -> config_audio_s1_agent:m0_waitrequest
	wire          config_audio_s1_agent_m0_debugaccess;                   // config_audio_s1_agent:m0_debugaccess -> config_audio_s1_translator:uav_debugaccess
	wire   [20:0] config_audio_s1_agent_m0_address;                       // config_audio_s1_agent:m0_address -> config_audio_s1_translator:uav_address
	wire    [3:0] config_audio_s1_agent_m0_byteenable;                    // config_audio_s1_agent:m0_byteenable -> config_audio_s1_translator:uav_byteenable
	wire          config_audio_s1_agent_m0_read;                          // config_audio_s1_agent:m0_read -> config_audio_s1_translator:uav_read
	wire          config_audio_s1_agent_m0_readdatavalid;                 // config_audio_s1_translator:uav_readdatavalid -> config_audio_s1_agent:m0_readdatavalid
	wire          config_audio_s1_agent_m0_lock;                          // config_audio_s1_agent:m0_lock -> config_audio_s1_translator:uav_lock
	wire   [31:0] config_audio_s1_agent_m0_writedata;                     // config_audio_s1_agent:m0_writedata -> config_audio_s1_translator:uav_writedata
	wire          config_audio_s1_agent_m0_write;                         // config_audio_s1_agent:m0_write -> config_audio_s1_translator:uav_write
	wire    [2:0] config_audio_s1_agent_m0_burstcount;                    // config_audio_s1_agent:m0_burstcount -> config_audio_s1_translator:uav_burstcount
	wire          config_audio_s1_agent_rf_source_valid;                  // config_audio_s1_agent:rf_source_valid -> config_audio_s1_agent_rsp_fifo:in_valid
	wire  [116:0] config_audio_s1_agent_rf_source_data;                   // config_audio_s1_agent:rf_source_data -> config_audio_s1_agent_rsp_fifo:in_data
	wire          config_audio_s1_agent_rf_source_ready;                  // config_audio_s1_agent_rsp_fifo:in_ready -> config_audio_s1_agent:rf_source_ready
	wire          config_audio_s1_agent_rf_source_startofpacket;          // config_audio_s1_agent:rf_source_startofpacket -> config_audio_s1_agent_rsp_fifo:in_startofpacket
	wire          config_audio_s1_agent_rf_source_endofpacket;            // config_audio_s1_agent:rf_source_endofpacket -> config_audio_s1_agent_rsp_fifo:in_endofpacket
	wire          config_audio_s1_agent_rsp_fifo_out_valid;               // config_audio_s1_agent_rsp_fifo:out_valid -> config_audio_s1_agent:rf_sink_valid
	wire  [116:0] config_audio_s1_agent_rsp_fifo_out_data;                // config_audio_s1_agent_rsp_fifo:out_data -> config_audio_s1_agent:rf_sink_data
	wire          config_audio_s1_agent_rsp_fifo_out_ready;               // config_audio_s1_agent:rf_sink_ready -> config_audio_s1_agent_rsp_fifo:out_ready
	wire          config_audio_s1_agent_rsp_fifo_out_startofpacket;       // config_audio_s1_agent_rsp_fifo:out_startofpacket -> config_audio_s1_agent:rf_sink_startofpacket
	wire          config_audio_s1_agent_rsp_fifo_out_endofpacket;         // config_audio_s1_agent_rsp_fifo:out_endofpacket -> config_audio_s1_agent:rf_sink_endofpacket
	wire          config_audio_s1_agent_rdata_fifo_src_valid;             // config_audio_s1_agent:rdata_fifo_src_valid -> config_audio_s1_agent_rdata_fifo:in_valid
	wire   [33:0] config_audio_s1_agent_rdata_fifo_src_data;              // config_audio_s1_agent:rdata_fifo_src_data -> config_audio_s1_agent_rdata_fifo:in_data
	wire          config_audio_s1_agent_rdata_fifo_src_ready;             // config_audio_s1_agent_rdata_fifo:in_ready -> config_audio_s1_agent:rdata_fifo_src_ready
	wire          hps_h2f_lw_axi_master_agent_write_cp_valid;             // hps_h2f_lw_axi_master_agent:write_cp_valid -> router:sink_valid
	wire  [115:0] hps_h2f_lw_axi_master_agent_write_cp_data;              // hps_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [115:0] hps_h2f_lw_axi_master_agent_read_cp_data;               // hps_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [115:0] led_s1_agent_rp_data;                                   // led_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] sw_s1_agent_rp_data;                                    // sw_s1_agent:rp_data -> router_003:sink_data
	...
	wire          record_d_s1_agent_rp_valid;                             // record_d_s1_agent:rp_valid -> router_004:sink_valid
	wire  [115:0] record_d_s1_agent_rp_data;                              // record_d_s1_agent:rp_data -> router_004:sink_data
	wire          record_d_s1_agent_rp_ready;                             // router_004:sink_ready -> record_d_s1_agent:rp_ready
	wire          record_d_s1_agent_rp_startofpacket;                     // record_d_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          record_d_s1_agent_rp_endofpacket;                       // record_d_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          play_d_s1_agent_rp_valid;                               // play_d_s1_agent:rp_valid -> router_005:sink_valid
	wire  [115:0] play_d_s1_agent_rp_data;                                // play_d_s1_agent:rp_data -> router_005:sink_data
	wire          play_d_s1_agent_rp_ready;                               // router_005:sink_ready -> play_d_s1_agent:rp_ready
	wire          play_d_s1_agent_rp_startofpacket;                       // play_d_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          play_d_s1_agent_rp_endofpacket;                         // play_d_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          config_audio_s1_agent_rp_valid;                         // config_audio_s1_agent:rp_valid -> router_006:sink_valid
	wire  [115:0] config_audio_s1_agent_rp_data;                          // config_audio_s1_agent:rp_data -> router_006:sink_data
	wire          config_audio_s1_agent_rp_ready;                         // router_006:sink_ready -> config_audio_s1_agent:rp_ready
	wire          config_audio_s1_agent_rp_startofpacket;                 // config_audio_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          config_audio_s1_agent_rp_endofpacket;                   // config_audio_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [115:0] router_src_data;                                        // router:src_data -> hps_h2f_lw_axi_master_wr_limiter:cmd_sink_data
	wire          router_src_ready;                                       // hps_h2f_lw_axi_master_wr_limiter:cmd_sink_ready -> router:src_ready
	wire    [4:0] router_src_channel;                                     // router:src_channel -> hps_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	...
	wire  [115:0] hps_h2f_lw_axi_master_wr_limiter_cmd_src_data;          // hps_h2f_lw_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          hps_h2f_lw_axi_master_wr_limiter_cmd_src_ready;         // cmd_demux:sink_ready -> hps_h2f_lw_axi_master_wr_limiter:cmd_src_ready
	wire    [4:0] hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel;       // hps_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [115:0] rsp_mux_src_data;                                       // rsp_mux:src_data -> hps_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                      // hps_h2f_lw_axi_master_wr_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                    // rsp_mux:src_channel -> hps_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [115:0] hps_h2f_lw_axi_master_wr_limiter_rsp_src_data;          // hps_h2f_lw_axi_master_wr_limiter:rsp_src_data -> hps_h2f_lw_axi_master_agent:write_rp_data
	...
	wire    [4:0] hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel;       // hps_h2f_lw_axi_master_wr_limiter:rsp_src_channel -> hps_h2f_lw_axi_master_agent:write_rp_channel
	...
	wire  [115:0] router_001_src_data;                                    // router_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:cmd_sink_data
	wire          router_001_src_ready;                                   // hps_h2f_lw_axi_master_rd_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [4:0] router_001_src_channel;                                 // router_001:src_channel -> hps_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	...
	wire  [115:0] hps_h2f_lw_axi_master_rd_limiter_cmd_src_data;          // hps_h2f_lw_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [4:0] hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel;       // hps_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [115:0] rsp_mux_001_src_data;                                   // rsp_mux_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                  // hps_h2f_lw_axi_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [4:0] rsp_mux_001_src_channel;                                // rsp_mux_001:src_channel -> hps_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire  [115:0] hps_h2f_lw_axi_master_rd_limiter_rsp_src_data;          // hps_h2f_lw_axi_master_rd_limiter:rsp_src_data -> hps_h2f_lw_axi_master_agent:read_rp_data
	...
	wire    [4:0] hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel;       // hps_h2f_lw_axi_master_rd_limiter:rsp_src_channel -> hps_h2f_lw_axi_master_agent:read_rp_channel
	...
	wire  [115:0] cmd_mux_src_data;                                       // cmd_mux:src_data -> led_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                      // led_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                    // cmd_mux:src_channel -> led_s1_burst_adapter:sink0_channel
	...
	wire    [4:0] led_s1_burst_adapter_source0_channel;                   // led_s1_burst_adapter:source0_channel -> led_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_001_src_data;                                   // cmd_mux_001:src_data -> sw_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                  // sw_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                // cmd_mux_001:src_channel -> sw_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] sw_s1_burst_adapter_source0_data;                       // sw_s1_burst_adapter:source0_data -> sw_s1_agent:cp_data
	wire          sw_s1_burst_adapter_source0_ready;                      // sw_s1_agent:cp_ready -> sw_s1_burst_adapter:source0_ready
	wire    [4:0] sw_s1_burst_adapter_source0_channel;                    // sw_s1_burst_adapter:source0_channel -> sw_s1_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                  // cmd_mux_002:src_valid -> record_d_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_002_src_data;                                   // cmd_mux_002:src_data -> record_d_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                  // record_d_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                // cmd_mux_002:src_channel -> record_d_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                          // cmd_mux_002:src_startofpacket -> record_d_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                            // cmd_mux_002:src_endofpacket -> record_d_s1_burst_adapter:sink0_endofpacket
	wire          record_d_s1_burst_adapter_source0_valid;                // record_d_s1_burst_adapter:source0_valid -> record_d_s1_agent:cp_valid
	wire  [115:0] record_d_s1_burst_adapter_source0_data;                 // record_d_s1_burst_adapter:source0_data -> record_d_s1_agent:cp_data
	wire          record_d_s1_burst_adapter_source0_ready;                // record_d_s1_agent:cp_ready -> record_d_s1_burst_adapter:source0_ready
	wire    [4:0] record_d_s1_burst_adapter_source0_channel;              // record_d_s1_burst_adapter:source0_channel -> record_d_s1_agent:cp_channel
	wire          record_d_s1_burst_adapter_source0_startofpacket;        // record_d_s1_burst_adapter:source0_startofpacket -> record_d_s1_agent:cp_startofpacket
	wire          record_d_s1_burst_adapter_source0_endofpacket;          // record_d_s1_burst_adapter:source0_endofpacket -> record_d_s1_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                  // cmd_mux_003:src_valid -> play_d_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                   // cmd_mux_003:src_data -> play_d_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                  // play_d_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                // cmd_mux_003:src_channel -> play_d_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                          // cmd_mux_003:src_startofpacket -> play_d_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                            // cmd_mux_003:src_endofpacket -> play_d_s1_burst_adapter:sink0_endofpacket
	wire          play_d_s1_burst_adapter_source0_valid;                  // play_d_s1_burst_adapter:source0_valid -> play_d_s1_agent:cp_valid
	wire  [115:0] play_d_s1_burst_adapter_source0_data;                   // play_d_s1_burst_adapter:source0_data -> play_d_s1_agent:cp_data
	wire          play_d_s1_burst_adapter_source0_ready;                  // play_d_s1_agent:cp_ready -> play_d_s1_burst_adapter:source0_ready
	wire    [4:0] play_d_s1_burst_adapter_source0_channel;                // play_d_s1_burst_adapter:source0_channel -> play_d_s1_agent:cp_channel
	wire          play_d_s1_burst_adapter_source0_startofpacket;          // play_d_s1_burst_adapter:source0_startofpacket -> play_d_s1_agent:cp_startofpacket
	wire          play_d_s1_burst_adapter_source0_endofpacket;            // play_d_s1_burst_adapter:source0_endofpacket -> play_d_s1_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                  // cmd_mux_004:src_valid -> config_audio_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                   // cmd_mux_004:src_data -> config_audio_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                  // config_audio_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                // cmd_mux_004:src_channel -> config_audio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                          // cmd_mux_004:src_startofpacket -> config_audio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                            // cmd_mux_004:src_endofpacket -> config_audio_s1_burst_adapter:sink0_endofpacket
	wire          config_audio_s1_burst_adapter_source0_valid;            // config_audio_s1_burst_adapter:source0_valid -> config_audio_s1_agent:cp_valid
	wire  [115:0] config_audio_s1_burst_adapter_source0_data;             // config_audio_s1_burst_adapter:source0_data -> config_audio_s1_agent:cp_data
	wire          config_audio_s1_burst_adapter_source0_ready;            // config_audio_s1_agent:cp_ready -> config_audio_s1_burst_adapter:source0_ready
	wire    [4:0] config_audio_s1_burst_adapter_source0_channel;          // config_audio_s1_burst_adapter:source0_channel -> config_audio_s1_agent:cp_channel
	wire          config_audio_s1_burst_adapter_source0_startofpacket;    // config_audio_s1_burst_adapter:source0_startofpacket -> config_audio_s1_agent:cp_startofpacket
	wire          config_audio_s1_burst_adapter_source0_endofpacket;      // config_audio_s1_burst_adapter:source0_endofpacket -> config_audio_s1_agent:cp_endofpacket
	...
	wire    [4:0] hps_h2f_lw_axi_master_wr_limiter_cmd_valid_data;        // hps_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [4:0] hps_h2f_lw_axi_master_rd_limiter_cmd_valid_data;        // hps_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          record_d_s1_agent_rdata_fifo_out_valid;                 // record_d_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] record_d_s1_agent_rdata_fifo_out_data;                  // record_d_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          record_d_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_002:in_0_ready -> record_d_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                      // avalon_st_adapter_002:out_0_valid -> record_d_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                       // avalon_st_adapter_002:out_0_data -> record_d_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                      // record_d_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                      // avalon_st_adapter_002:out_0_error -> record_d_s1_agent:rdata_fifo_sink_error
	wire          play_d_s1_agent_rdata_fifo_out_valid;                   // play_d_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] play_d_s1_agent_rdata_fifo_out_data;                    // play_d_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          play_d_s1_agent_rdata_fifo_out_ready;                   // avalon_st_adapter_003:in_0_ready -> play_d_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                      // avalon_st_adapter_003:out_0_valid -> play_d_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                       // avalon_st_adapter_003:out_0_data -> play_d_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                      // play_d_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                      // avalon_st_adapter_003:out_0_error -> play_d_s1_agent:rdata_fifo_sink_error
	wire          config_audio_s1_agent_rdata_fifo_out_valid;             // config_audio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] config_audio_s1_agent_rdata_fifo_out_data;              // config_audio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          config_audio_s1_agent_rdata_fifo_out_ready;             // avalon_st_adapter_004:in_0_ready -> config_audio_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                      // avalon_st_adapter_004:out_0_valid -> config_audio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                       // avalon_st_adapter_004:out_0_data -> config_audio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                      // config_audio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                      // avalon_st_adapter_004:out_0_error -> config_audio_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) record_d_s1_translator (
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (led_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (record_d_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (record_d_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (record_d_s1_agent_m0_read),             //                         .read
		.uav_write              (record_d_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (record_d_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (record_d_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (record_d_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (record_d_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (record_d_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (record_d_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (record_d_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (record_d_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (record_d_s1_write),                     //                         .write
		.av_readdata            (record_d_s1_readdata),                  //                         .readdata
		.av_writedata           (record_d_s1_writedata),                 //                         .writedata
		.av_chipselect          (record_d_s1_chipselect),                //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) play_d_s1_translator (
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (led_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (play_d_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (play_d_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (play_d_s1_agent_m0_read),               //                         .read
		.uav_write              (play_d_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (play_d_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (play_d_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (play_d_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (play_d_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (play_d_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (play_d_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (play_d_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (play_d_s1_address),                     //      avalon_anti_slave_0.address
		.av_write               (play_d_s1_write),                       //                         .write
		.av_readdata            (play_d_s1_readdata),                    //                         .readdata
		.av_writedata           (play_d_s1_writedata),                   //                         .writedata
		.av_chipselect          (play_d_s1_chipselect),                  //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) config_audio_s1_translator (
		.clk                    (clk_0_clk_clk),                          //                      clk.clk
		.reset                  (led_reset_reset_bridge_in_reset_reset),  //                    reset.reset
		.uav_address            (config_audio_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (config_audio_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (config_audio_s1_agent_m0_read),          //                         .read
		.uav_write              (config_audio_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (config_audio_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (config_audio_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (config_audio_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (config_audio_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (config_audio_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (config_audio_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (config_audio_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (config_audio_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (config_audio_s1_write),                  //                         .write
		.av_readdata            (config_audio_s1_readdata),               //                         .readdata
		.av_writedata           (config_audio_s1_writedata),              //                         .writedata
		.av_chipselect          (config_audio_s1_chipselect),             //                         .chipselect
		.av_read                (),                                       //              (terminated)
		.av_begintransfer       (),                                       //              (terminated)
		.av_beginbursttransfer  (),                                       //              (terminated)
		.av_burstcount          (),                                       //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (led_reset_reset_bridge_in_reset_reset),           //       clk_reset.reset
		.m0_address              (record_d_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (record_d_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (record_d_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (record_d_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (record_d_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (record_d_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (record_d_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (record_d_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (record_d_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (record_d_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (record_d_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (record_d_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (record_d_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (record_d_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (record_d_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (record_d_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (record_d_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (record_d_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (record_d_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (record_d_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (record_d_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (record_d_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (record_d_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (record_d_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (record_d_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (record_d_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (record_d_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (record_d_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (record_d_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (record_d_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (record_d_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (record_d_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),               //                .error
		.rdata_fifo_src_ready    (record_d_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (record_d_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (record_d_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) record_d_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (led_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (record_d_s1_agent_rf_source_data),             //        in.data
		.in_valid          (record_d_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (record_d_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (record_d_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (record_d_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (record_d_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (record_d_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (record_d_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (record_d_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (record_d_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) record_d_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                          //       clk.clk
		.reset             (led_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (record_d_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (record_d_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (record_d_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (record_d_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (record_d_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (record_d_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                  // (terminated)
		.csr_read          (1'b0),                                   // (terminated)
		.csr_write         (1'b0),                                   // (terminated)
		.csr_readdata      (),                                       // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (led_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (play_d_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (play_d_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (play_d_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (play_d_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (play_d_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (play_d_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (play_d_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (play_d_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (play_d_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (play_d_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (play_d_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (play_d_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (play_d_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (play_d_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (play_d_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (play_d_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (play_d_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (play_d_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (play_d_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (play_d_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (play_d_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (play_d_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (play_d_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (play_d_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (play_d_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (play_d_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (play_d_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (play_d_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (play_d_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (play_d_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (play_d_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (play_d_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),             //                .error
		.rdata_fifo_src_ready    (play_d_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (play_d_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (play_d_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) play_d_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (led_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (play_d_s1_agent_rf_source_data),             //        in.data
		.in_valid          (play_d_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (play_d_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (play_d_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (play_d_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (play_d_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (play_d_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (play_d_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (play_d_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (play_d_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) play_d_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                         //       clk.clk
		.reset             (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (play_d_s1_agent_rdata_fifo_src_data),   //        in.data
		.in_valid          (play_d_s1_agent_rdata_fifo_src_valid),  //          .valid
		.in_ready          (play_d_s1_agent_rdata_fifo_src_ready),  //          .ready
		.out_data          (play_d_s1_agent_rdata_fifo_out_data),   //       out.data
		.out_valid         (play_d_s1_agent_rdata_fifo_out_valid),  //          .valid
		.out_ready         (play_d_s1_agent_rdata_fifo_out_ready),  //          .ready
		.csr_address       (2'b00),                                 // (terminated)
		.csr_read          (1'b0),                                  // (terminated)
		.csr_write         (1'b0),                                  // (terminated)
		.csr_readdata      (),                                      // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) config_audio_s1_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (led_reset_reset_bridge_in_reset_reset),               //       clk_reset.reset
		.m0_address              (config_audio_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (config_audio_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (config_audio_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (config_audio_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (config_audio_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (config_audio_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (config_audio_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (config_audio_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (config_audio_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (config_audio_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (config_audio_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (config_audio_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (config_audio_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (config_audio_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (config_audio_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (config_audio_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (config_audio_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (config_audio_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (config_audio_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (config_audio_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (config_audio_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (config_audio_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (config_audio_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (config_audio_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (config_audio_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (config_audio_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (config_audio_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (config_audio_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (config_audio_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (config_audio_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (config_audio_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (config_audio_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (config_audio_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (config_audio_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (config_audio_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) config_audio_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (led_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_data           (config_audio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (config_audio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (config_audio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (config_audio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (config_audio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (config_audio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (config_audio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (config_audio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (config_audio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (config_audio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) config_audio_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (led_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (config_audio_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (config_audio_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (config_audio_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (config_audio_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (config_audio_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (config_audio_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	hps_fpga_mm_interconnect_1_router router (
	...
	hps_fpga_mm_interconnect_1_router router_001 (
	...
	hps_fpga_mm_interconnect_1_router_002 router_002 (
	...
	hps_fpga_mm_interconnect_1_router_002 router_003 (
	...
	hps_fpga_mm_interconnect_1_router_002 router_004 (
		.sink_ready         (record_d_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (record_d_s1_agent_rp_valid),            //          .valid
		.sink_data          (record_d_s1_agent_rp_data),             //          .data
		.sink_startofpacket (record_d_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (record_d_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_router_002 router_005 (
		.sink_ready         (play_d_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (play_d_s1_agent_rp_valid),              //          .valid
		.sink_data          (play_d_s1_agent_rp_data),               //          .data
		.sink_startofpacket (play_d_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (play_d_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_router_002 router_006 (
		.sink_ready         (config_audio_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (config_audio_s1_agent_rp_valid),         //          .valid
		.sink_data          (config_audio_s1_agent_rp_data),          //          .data
		.sink_startofpacket (config_audio_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (config_audio_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (record_d_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (record_d_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (record_d_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (record_d_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (record_d_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (record_d_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (play_d_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (play_d_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (play_d_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (play_d_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (play_d_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (play_d_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (config_audio_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (config_audio_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (config_audio_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (config_audio_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (config_audio_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (config_audio_s1_burst_adapter_source0_ready)          //          .ready
	);

	hps_fpga_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                     //        clk.clk
		.reset              (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                     //        clk.clk
		.reset              (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                     //       clk.clk
		.reset               (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                     //       clk.clk
		.reset               (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fpga_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (led_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (record_d_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (record_d_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (record_d_s1_agent_rdata_fifo_out_ready), //         .ready
	...
	hps_fpga_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (led_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (play_d_s1_agent_rdata_fifo_out_data),   //     in_0.data
		.in_0_valid     (play_d_s1_agent_rdata_fifo_out_valid),  //         .valid
		.in_0_ready     (play_d_s1_agent_rdata_fifo_out_ready),  //         .ready
	...
	hps_fpga_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (led_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
		.in_0_data      (config_audio_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (config_audio_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (config_audio_s1_agent_rdata_fifo_out_ready), //         .ready
