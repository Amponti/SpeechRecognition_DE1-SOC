...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE1_SoC_Audio.jdi
...
# Design Name 
# setting SOPC_NAME is audio_nios
SOPC_NAME := audio_nios
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x5101040
SOPC_SYSID_FLAG += --sidp=0x5101040
ELF_PATCH_FLAG  += --sidp 0x5101040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1465263482
SOPC_SYSID_FLAG += --timestamp=1465263482
ELF_PATCH_FLAG  += --timestamp 1465263482
