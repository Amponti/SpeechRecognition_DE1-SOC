...
module LowPass_40Hz (
	...
	LowPass_40Hz_ast	LowPass_40Hz_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="LowPass_40Hz_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_bit_width" value="17"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass 40Hz, Imported, E:\EEG_DEVICE_with_lowPass_Filter\Coef_Filter\coef_40Hz.txt, -0.263292, 7.501144, 327.54996, 2455.4739, 9239.277, 21883.941, 35751.76, 41943.04, 35751.76, 21883.941, 9239.277, 2455.4739, 327.54996, 7.501144, -0.263292"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "output_full_bits_right_of_binary_point" value="27"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "coefficient_reload_bit_width" value="20"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "logic_cell" value="559"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="LowPass_40Hz.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
