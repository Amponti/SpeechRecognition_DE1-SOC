...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "LowPass_40Hz_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "LowPass_40Hz_st" "LOGIC ELEMENTS"
}
add_fir_constraints
