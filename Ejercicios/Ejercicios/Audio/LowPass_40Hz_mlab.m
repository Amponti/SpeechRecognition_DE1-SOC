...
%LSB Truncated bits:17
%FIR Width (Full Calculation Width Before Output Width Adjust) :   30
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = LowPass_40Hz_mlab_mat (stimulation, output)
	coef_matrix=[0 7 327 2455 9239 21883 35751 41943 35751 21883 9239 2455 327 7 0 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 1;
	MSB_TYPE  = 0;
