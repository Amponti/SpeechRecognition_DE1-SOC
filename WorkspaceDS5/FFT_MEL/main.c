...
int main(int argc, char *argv[])
{
	...
	char riff[4],wave[4],fmt[4],stuf,data[4],more[4];
	char sbyte[2];
...
//		swrite = fwrite(&sbyte, 1, 1, outp);
	...
	melcepstrum_conversion(&fftcoefs[0], N*NUM_SAMPLES, &mel[0], 26, 8000);
